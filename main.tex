...
Essential Question & What is meaningful communication like for students with complex needs? \\
Primary Sources & Norrie et al.; Downing et al.; Peckham-Hardin \\
Applied Evidence & Posted TD Snap review, Communication Support Plan, EDE448 Modules 1--2, K--5 teaching placement, and EDU486 Invisible Invaders camp \\
...
\input{sections/01_meaningful_communication}
\input{sections/02_context_classroom_and_camp}
\input{sections/03_behavior_power_and_evidence}
\input{sections/04_media_future_practice_and_conclusion}
